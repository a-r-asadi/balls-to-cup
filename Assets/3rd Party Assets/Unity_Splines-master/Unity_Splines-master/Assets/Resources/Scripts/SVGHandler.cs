...
{		
	...
	static Vector2 scaleSVG = new Vector2(1f, 1f);
	...
	public static void ConvertToSplines(string filePath)
	{
		...
		widthSVG = -1;
		heightSVG = -1;
		scaleSVG = new Vector2(1f, 1f);
	}

	static SplineGenerator CreateSpline()
	{
		var prefab = (GameObject)Resources.Load("Prefabs/Spline", typeof(GameObject));
		return GameObject.Instantiate(prefab, LevelGenerator.instance.transform).GetComponent<SplineGenerator>();
	}
